...
DEFINSTR(Return, false, false, false, 4, "jump +0")   // stupid hack because apparently we can't have real return statements
...
DEFINSTR(XOR, true, true, false, 4, "^")
DEFINSTR(Pos, true, true, false, 4, "+")
DEFINSTR(Neg, true, true, false, 4, "-")
DEFINSTR(BNeg, true, true, false, 4, "~")
DEFINSTR(LNeg, true, true, false, 4, "!")